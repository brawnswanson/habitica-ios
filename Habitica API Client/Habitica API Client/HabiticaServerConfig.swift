...
public class HabiticaServerConfig {
    ...
    public static let localhost = ServerConfiguration(scheme: "http", host: "192.168.3.170:3000", apiRoute: "api/\(Constants.defaultApiVersion)")
    ...
    public static var current = localhost
